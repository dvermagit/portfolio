    ...
    <div className="min-h-screen pt-32 pb-20 px-4 md:px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-16">
          <div
            className={`w-full md:w-1/3 transition-all duration-700 delay-200 ${
              isLoaded
            ...
            >
              ...
              <div className="space-y-4 text-foreground/80 glass-card p-6">
                <p>
                  ...
                  scalable, reliable, and secure applications with a strong
                ...
                <p>
                  ...
                  I'm particularly excited about software scalability,
                  reliability, and security, always dedicated to delivering
                  great user experiences.
                </p>
                <p>
                  As a developer, I enjoy working on challenging problems and
                  finding elegant solutions. I believe in writing clean,
                  maintainable code and using the right tools for the job.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="glass-card p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <p className="text-sm font-medium bg-portfolio-mint/20 text-portfolio-mint px-2 py-0.5 rounded">
                    2021-2025
                  </p>
                </div>
                <p className="text-sm text-foreground/80">
                  Studying the fundamentals of AI and ML while exploring
                  software development on the side.
                </p>
              </div>
            </div>
              ...
              <div className="glass-card p-6 space-y-4">
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80 mt-1">
                      Began learning web development fundamentals and built my
                      first projects.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80 mt-1">
                      Developed expertise in MongoDB, Express, React, and
                      Node.js.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80 mt-1">
                      Currently focused on building scalable and reliable
