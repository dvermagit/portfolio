          ...
          >
            <div className="glass-card p-8 h-full hover:border-white/20 transition-all duration-300">
              ...
              <div className="space-y-6">
                <div
                  className={`flex items-start transition-all duration-700 delay-100 ${
                    isLoaded
                ...
                <div
                  className={`flex items-start transition-all duration-700 delay-200 ${
                    isLoaded
                      ? "opacity-100 translate-x-0"
                      : "opacity-0 -translate-x-10"
                  }`}
                ...
                <div
                  className={`flex items-start transition-all duration-700 delay-400 ${
                    isLoaded
                      ? "opacity-100 translate-x-0"
                      : "opacity-0 -translate-x-10"
                  }`}
                >
                  ...
                  <div>
                    ...
                    <a
                      href="https://linkedin.com/in/dhruv-verma-73b2982b0"
                      target="_blank"
                      rel="noopener noreferrer"
